...
public class OldVars {
	...
	public  final int OPTIONVALUE[] = {1,2,3};
	public static boolean DYNAMICV = false;
	public static boolean DYNAMICV2 = false;
	public static boolean DYNAMICV3 = false;
	public static boolean DYNAMICV4 = false;
