...
public class GunnarsGround extends Node{
	...
	public GunnarsGround(MethodContext ctx) {
		super(ctx);
	}
	...
	private void cs1() {
		...
		if((ctx.settings.get(2111)>>7 &0x7) == 4){
