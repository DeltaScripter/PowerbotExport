...
public class FlaxStuff extends FlaxNode{
	...
	//Items
	public static int FLAX = 1779;//1779;//is for actual flax    //wool ID is 1737(for testing purposes)
	public static int BOWSTRING = 1777;//1777;//ball of wool 1759(same as above)
