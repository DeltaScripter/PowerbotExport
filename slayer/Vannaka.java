...
public class Vannaka extends SlayerNode{
	...
	public Vannaka(ClientContext ctx) {
		super(ctx);
	}
	...
	public boolean activate() {
		return ctx.varpbits.varpbit(183)==0 && slayerbody.master=="Vannaka";
	}
	...
	public void execute() {
		...
		if(new Tile(3105,9910,0).matrix(ctx).reachable()){
		...
		}else if(new Tile(3102,9909,0).matrix(ctx).reachable()){
