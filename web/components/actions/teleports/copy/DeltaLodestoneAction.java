package web.components.actions.teleports.copy;
...
public class DeltaLodestoneAction extends DeltaWebAction {
	...
	public DeltaLodestoneAction(final String name,final Tile target, final int childId) {
